  ...
  <v-app>
    ...
    <v-content>
      <v-container class="pa-12" style="color: white !important" fluid>
        ...
        <p
          class="western"
          style="margin-bottom: 0in; border: none; padding: 0in; line-height: 153%"
        >
          <br />
        </p>
        <p
        ...
        >
          <span>
            ...
            text), that interferes with any party&rsquo;s uninterrupted use and
        ...
        <p
          class="western"
          style="margin-left: 0.21in; margin-bottom: 0in; border: none; padding: 0in; line-height: 100%"
        >
          <br />
        </p>
        <p
        ...
        >
          ...
          provided to and stored in your Third-Party Account (the &ldquo;Social
          Network Content&rdquo;) so that it is available on and through the
        ...
        >
          ...
          <font color="#1155cc">
            <u>
              <a href="https://www.iubenda.com/privacy-policy/45992810"
                >https</a
              >
          ...
          in __________, then through your continued use of the Site, you are
          transferring your data to __________, and you agree to have your data
        ...
        >
          ...
          Italy, and the use of the United Nations Convention of Contracts for
          ...
          provisions of the law of your country of residence. Holophonica and
          yourself both agree to submit to the non-exclusive jurisdiction of the
          courts of Bologna, which means that you may make a claim to defend
          your consumer protection rights in regards to these Conditions of Use
          in Italy, or in the EU country in which you reside.
        </p>
        <p
          class="western"
          style="margin-bottom: 0in; border: none; padding: 0in; line-height: 150%"
        ...
        >
          ...
          Bologna, Italy. The language of the proceedings shall be English.
          Applicable rules of substantive law shall be the law of Italy.
        </p>
        <p
          class="western"
          align="justify"
